...
class BareboneBuilder:
    ...
    def run_kernel(self):
        ...
        self.execute_command('sudo mkdir /mnt/isos10',False)
        self.execute_command('sudo chmod 777 /mnt/isos10',False)
        self.execute_command('sudo mount.exfat-fuse "$filename" /mnt/isos10'.replace("$filename",filename),True)
        
        
       
        self.execute_command("nautilus --browser /mnt/isos10",False)
    ...
    def copy_file(self):
        ...
        if 0==0:
            self.execute_command("sudo umount /mnt/isos10",True)
