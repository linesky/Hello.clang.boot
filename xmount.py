...
class BareboneBuilder:
    ...
    def run_kernel(self):
        ...
        self.execute_command('sudo mkdir /mnt/isos4',False)
        self.execute_command('sudo chmod 777 /mnt/isos4',False)
        self.execute_command('sudo xmount --in raw "$filename" --out raw /mnt/isos4 -o loop'.replace("$filename",filename),True)
        
        
       
        self.execute_command("nautilus --browser /mnt/isos4",False)
    ...
    def copy_file(self):
        ...
        if 0==0:
            self.execute_command("sudo umount /mnt/isos4",True)
