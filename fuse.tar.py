...
class BareboneBuilder:
    ...
    def run_kernel(self):
        ...
        self.execute_command('mkdir /tmp/isos8',False)
        self.execute_command('chmod 777 /tmp/isos8',False)
        self.execute_command('archivemount "$filename" /tmp/isos8'.replace("$filename",filename),True)
        
        
       
        self.execute_command("nautilus --browser /tmp/isos8",False)
    ...
    def copy_file(self):
        ...
        if 0==0:
            self.execute_command("umount /tmp/isos8",True)
